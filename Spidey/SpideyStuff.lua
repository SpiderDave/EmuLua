...
spidey.setregister = memory.setregister
spidey.getregister = memory.getregister
    ...
    if enable then
        ...
        spidey.register(0x4014,1, function(opt, address, size)
            ...
            for i = 0,63 do
                ...
                if (spidey.oam.spriteSize == 1) and (spidey.oam.sprite[i].tile % 2 == 1) then
                    spidey.oam.sprite[i].tile = spidey.oam.sprite[i].tile - 1
                end
