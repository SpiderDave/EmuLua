...
local items = {
    ...
    },
    {
        name = "Thorn Whip",
        type = "whip",
        desc = "A whip adorned with large,\nsharp thorns.",
        whipBase = 1,
        attack = 11,
        pierce = 7,
    },
    ...
    },
    {
        name = "Morning Star",
        type = "whip",
        desc = "A chain whip with a \nspiked metal ball on the \nend.",
        whipBase = 3,
        attack = 20,
    },
    {
        name = "Flame Whip",
        type = "whip",
        desc = "A Whip imbued with magic \nto emit a powerful flame.",
        whipBase = 4,
        attack = 25,
    },
    {
        name = "Poison Whip",
        type = "whip",
        desc = "Damages enemies over time.",
        whipBase = 1,
        attack = 8,
        pierce = 5,
    },
