...
for i=1,8 do
    local n = cv2data.relics[i].name
    cv2data.relics[i].displayNameLong = string.gsub(" "..n, "%W%l", string.upper):sub(2)
    
    cv2data.relics[i].varName = cv2data.relics[i].varName or cv2data.relics[i].name
end
...
cv2data.clues = {0x1e, 0x1f, 0x20, 0x42, 0x0d, 0x22, 0x21, 0x5c, 0x24, 0x23, 0x14, 0x25, 0x11}
...
cv2data.placedItems = {
    ...
    {x=0x3e4, y=0xa9, area = {0x00,0x00,0x00}, name="Gold", location="jova top right side."},
...
--cv2data.placedItems = {} -- disabled

cv2data.placedItems = {
    --{x=0xc4, y=0xa9+32, area = {0x00,0x00,0x00}, name="Save Crystal", location="jova top right side."},
    
    {x=0xd4, y=0xc8, area = {0x01,0x00,0x00}, name="Save Crystal", location="laruba door."},
    {x=0xd4, y=0xc8, area = {0x01,0x01,0x00}, name="Save Crystal", location="berkeley door."},
    {x=0xd4, y=0xc8, area = {0x01,0x02,0x00}, name="Save Crystal", location="rover door."},
    {x=0xd4, y=0xc8, area = {0x01,0x03,0x00}, name="Save Crystal", location="brahm's door."},
    {x=0xd4, y=0xc8, area = {0x01,0x04,0x00}, name="Save Crystal", location="bodley door."},
    {x=0x2ec, y=0x368, area = {0x05,0x00,0x00}, name="Save Crystal", location="castlevania."},
