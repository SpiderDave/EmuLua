local candles = {
    ...
    {x=0x20, y=0x320, area = {0x01,0x06,0x01,0x81}, floor=0x349, location="Laruba", item="Wall Chicken", },
    {x=0x160, y=0x230, area = {0x01,0x07,0x00,0x81}, floor=0x269, location="Berkeley", },
    {x=0x150, y=0x230, area = {0x01,0x07,0x00,0x81}, floor=0x269, location="Berkeley", item="Wall Chicken", },
    {x=0x180, y=0x230, area = {0x01,0x07,0x00,0x81}, floor=0x269, location="Berkeley", },
    {x=0x90, y=0x60, area = {0x00,0x0d,0x00,0x01}, floor=0xc9, location="(room)", },
}
